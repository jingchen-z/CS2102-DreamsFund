						...
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<?php
								...
								if(!empty($row)){
									...
									echo '<h2><a href="'.$resource_url.'" target="'._blank.'">Visit company website</a></h2>';
									echo "<h2>Project category: $row[category]</h2>";
								}else{
									echo 'empty results!!';
								}
							?>
				...
				<div class="col-md-4 col-sm-4">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<?php
							...
							$result = pg_query($db, "SELECT get_total_current_fund($project_id)");
				...
				<div class="col-md-4 col-sm-4">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<?php
							...
							$result = pg_query($db, "SELECT get_total_transactions($project_id)");
							$row = pg_fetch_row($result);
							if(!empty($row)){
								echo "<p>$row[0]</p>";
							} else{
				...
				<div class="container">
							...
							<?php
								...
								if(!empty($row)){
									if($row[status] == 'ONGOING'){
										echo "<h2>More to do with your projects</h2>";
									}else{
										echo "<h2>Start your business, anytime, anywhere.</h2>";
									}
					...
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2">
							<form class="form-inline" action="editProjectDetail.php?project_id=<?php echo $project_id ?>\" method="POST">
								<div class="col-md-6 col-md-offset-3 col-sm-6">
									<?php
										...
										if(!empty($row)){
											if($row[status] == 'ONGOING'){
												echo "<button type=\"submit\" class=\"btn btn-default btn-block\" name=\"editProject\">Edit project details</button>";
											}
										}
									?>	
								</div>
							...
							<?php
								if(isset($_POST['editProject'])){
									$project_id = intval($_GET["project_id"]);
									echo '<meta http-equiv="refresh" content="0; URL=editProjectDetail.php?project_id='.$project_id.'" />';
								}
							?>
						</div>
					</div>
				...
				<div class="container">
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2">
							<form class="form-inline" action="#" method="POST">
								<div class="col-md-6 col-md-offset-3 col-sm-6">
									<?php
										...
										if(!empty($row)){
											if($row[status] == 'ONGOING'){
												echo "<button type=\"submit\" class=\"btn btn-default btn-block\" name=\"endProject\">End the project</button>";
											}
										}
									?>		
								</div>
							...
							<?php
								if(isset($_POST['endProject'])){
									$project_id = intval($_GET["project_id"]);
									echo '<meta http-equiv="refresh" content="0; URL=endProjectConfirmationCheck.php?project_id='.$project_id.'" />';
								}
							?>
						</div>
					</div>
