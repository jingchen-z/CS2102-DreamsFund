...
<html>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h2>See what you have contributed to other people's business.</h2>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="fh5co-services" class="fh5co-bg-section">
		<?php
			...
			$result = pg_query($db, "SELECT * FROM fund WHERE funding_user = '$userEmail'");
			$rows = pg_fetch_all($result);
			if(!empty($rows)){
				foreach($rows as $row){
					$project_id = $row[funded_project];
					$result2 = pg_query($db, "SELECT * FROM project_initiated_by WHERE project_id = $project_id");
					$project_info = pg_fetch_assoc($result2);
					echo "
						<div class=\"container\">
						<div class=\"row\">
							<div class=\"col-md-4 col-sm-4\">
								<div class=\"feature-center animate-box\" data-animate-effect=\"fadeIn\">
									...
									<h3>Project</h3>
									<p><a href=\"projectDetails.php?project_id=".$project_id."\">".$project_info[title]."</a></p>
								</div>
							</div>
							<div class=\"col-md-4 col-sm-4\">
								<div class=\"feature-center animate-box\" data-animate-effect=\"fadeIn\">
				...
				echo '<p>You have not donated funds to any projects.</p>';
			}
		?>
