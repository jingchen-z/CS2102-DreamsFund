				...
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<form action="editUserProfile.php" method="POST" autocomplete="off">
								...
								<?php
									...
									if(!empty($row)){
										echo "<input type=\"text\" name=\"first_name\" id=\"first_name\" class=\"form-control\" placeholder=\"Your first name\" value=$row[first_name]>";
									}
								?>
								</div>
								...
								<?php
									...
									$row = pg_fetch_assoc($result);
									if(!empty($row)){
										echo "<input type=\"text\" name=\"last_name\" id=\"last_name\" class=\"form-control\" placeholder=\"Your last name\" value=$row[last_name]>";
									}
								?>
								</div>
								...
								<?php
									...
									$row = pg_fetch_assoc($result);
									if(!empty($row)){
										echo "<input type=\"text\" name=\"location\" id=\"location\" class=\"form-control\" placeholder=\"Your location\" value=$row[location]>";
									}
								?>
								</div>
					...
					<?php
						...
						if(isset($_POST['Save'])) {
							$result = pg_query($db, "UPDATE users SET first_name = '$_POST[first_name]', last_name = '$_POST[last_name]', location = '$_POST[location]' WHERE email = '$_SESSION[user_email]'");
							if (!$result) {
