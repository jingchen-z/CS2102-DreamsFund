			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<?php
						...
						$result = pg_query($db, "SELECT * FROM users WHERE email = '$userEmail'");
					...
					<form class="form-inline" action="userProfile.php" method="POST">
						<div class="col-md-6 col-md-offset-3 col-sm-6">
							<button type="submit" class="btn btn-default btn-block" name="changeAccountPassword">Change account password</button>
							<?php
								if(isset($_POST['changeAccountPassword'])){
									echo '<meta http-equiv="refresh" content="0; URL=changeAccountPassword.php" />';
								}
							?>
						</div>
					</form>
					<form class="form-inline" action="userProfile.php" method="POST">
						<div class="col-md-6 col-md-offset-3 col-sm-6">
							<button type="submit" class="btn btn-default btn-block" name="changeTransactionPassword">Change transaction password</button>
							<?php
								if(isset($_POST['changeTransactionPassword'])){
									echo '<meta http-equiv="refresh" content="0; URL=changeTransactionPassword.php" />';
								}
							?>
						</div>
					</form>
		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2">
					<form class="form-inline" action="allMyProjects.php?status=ONGOING" method="POST">
						<div class="col-md-6 col-md-offset-3 col-sm-6">
							<button type="submit" class="btn btn-default btn-block" name="viewMyProjects">View all my projects</button>
							<?php
								if(isset($_POST['viewMyProjects'])){
									echo "<meta http-equiv='refresh' content='0; URL=allMyProjects.php?status=ONGOING />";
								}
							?>
						</div>
					</form>
            ...
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2">
                    <form class="form-inline" action="allMyDonations.php" method="POST">
                        <div class="col-md-6 col-md-offset-3 col-sm-6">
                            <button type="submit" class="btn btn-default btn-block" name="viewMyDonations">View all my donations</button>
                            <?php
                                if(isset($_POST['viewMyDonations'])){
                                    echo "<meta http-equiv='refresh' content='0; URL=allMyDonations.php />";
                                }
                                ?>
                        </div>
                    </form>
