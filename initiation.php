				...
				<div class="col-md-6 animate-box">
					...
					<form action="initiation.php" method="POST" autocomplete="off">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="resource_url" id="resource_url" class="form-control" placeholder="Your Company's URL">
							</div>
						</div>
					...
					<?php		
						...
						if(isset($_POST['Initiate'])) {
							$result = pg_query($db, "INSERT INTO project_initiated_by 
								(title, resource_url, description, start_date, duration_of_months, funding_sought, bank_account, country, city, initiator, category)
								VALUES(
									'$_POST[title]',
									'$_POST[resource_url]', 
									'$_POST[description]',
									...
									'$_POST[city]',
									'$account_email',
									'$_POST[category]') RETURNING project_id"
							);
							
							if (!$result) {
								echo '<meta http-equiv="refresh" content="0; URL=initiationFailure.php" />';
		        	} else {
		        		...
		        		if ($project_id == null) {
		        		  ...
		        		  echo'<form method="POST" action="initiationSuccess.php">
	    							<label for="inputName">Name:</label>
								    <input type="text" name="name" id="inputName">
								    <input type="submit" value="Submit">
							    </form>';
		        		echo '<meta http-equiv="refresh" content="0; URL=initiationSuccess.php?project_id='.$project_id.'" />';
		        		}
		        	}
						}
					?>	
